package com.tatas.gd12_pdf_a_10731
...
import com.tatas.gd12_pdf_a_10731.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createPdf(nama: String, umur: String, tlp: String, alamat: String, kampus: String) {
        ...
        val file = File(pdfPath, "pdf_10731.pdf")
        ...
        @SuppressLint("UseCompactLoadingForDrawables") val d = getDrawable(R.drawable.hos)
